...
<html lang="en">
    ...
    <body>
    <nav id="nav" class=" blue lighten-1 black-text" role="navigation">
        <div class="nav-wrapper container ">
            <a href="http://web-2-project-1-selo810.c9users.io/opportunities" class="brand-logo white-text" id="logo-container" terget="_blank">Server Side</a>
            <ul class="right hide-on-med-and-down blue-text">
                <li><a href="https://cms-with-auth-seanskiver.c9users.io/admin/categories">Home</a></li>
